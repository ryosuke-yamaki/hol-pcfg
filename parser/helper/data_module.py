"""Data loading: builds fastNLP DataSet/Vocabulary from preprocessed pickle files
and yields padded, length-bucketed batches for training/eval."""
import pickle
...
class DataModule():
    ...
    def setup(self):
        ...
        collapse_numbers = data.get('collapse_numbers', True)
        ...
        def clean_word(words):
            ...
            def process(w):
                ...
                if collapse_numbers:
                    w = clean_number(w)
                return w
            return [process(word) for word in words]
