...
class FastBLPCFG(PCFG_base):
    ...
    def decode(self, rules, lens, mbr=True, viterbi=False, eval_dep=False):
        ...
        # Dependency evaluation is not implemented for this bi-lexicalized PCFG decoder;
        # eval_dep is accepted for API compatibility but yields no dependency output.
        if eval_dep:
            pass
