"""Numerical verification of HNPCFGPairwise scoring functions (SemInfo repo).

Mirrors hol-pcfg/tests/test_hn_pcfg_scoring.py. Checks that:
...
from parsing_by_maxseminfo.parser.model.HN_PCFG import HNPCFGPairwise
...
def _build_model(scoring_fn, s_dim):
    ...
    return HNPCFGPairwise(args, vocab_size=7)
